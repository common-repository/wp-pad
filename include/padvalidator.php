...
class PADValidationError
{
	...
	{
		echo "<b>" . htmlspecialchars ( $Title ) . "</b> " . htmlspecialchars ( $Text ) . " " . "<i>" . htmlspecialchars ( $Descr ) . "</i>";
	}
}
...
class PADValidationRegExError extends PADValidationError
{
	...
	{
		$this->DumpValue ( $this->SpecFieldNode->GetValue ( "Name" ), $this->Value );
		$this->DumpError ( $this->SpecFieldNode->GetValue ( "Title" ), "does not match specification:", $this->SpecFieldNode->GetValue ( "RegExDocumentation" ) );
	}
}
...
class PADValidationDependencyError extends PADValidationError
{
	...
	function Dump()
	{
		...
		$this->DumpError ( $this->SpecFieldNode1->GetValue ( "Title" ) . ", " . $this->SpecFieldNode2->GetValue ( "Title" ), "do not match dependency:", $this->SpecFieldNode1->GetValue ( "Dependencies" ) );
	}
}
...
class PADValidator extends PADSpec
{
	...
	function Validate(&$PADFile)
	{
		...
		$DescrFieldNames = array ("Keywords", "Char_Desc_45", "Char_Desc_80", "Char_Desc_250", "Char_Desc_450", "Char_Desc_2000" );
